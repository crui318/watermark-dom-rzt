(function (root,factory) {
    ...
    var loadMark = function(settings) {
        var defaultSettings={
            ...
            watermark_x:0,//20,                 //水印起始位置x轴坐标
            watermark_y:210,//20,               //水印起始位置Y轴坐标
            watermark_rows:0,                   //水印行数
            watermark_cols:0,                   //水印列数
            watermark_x_space:0,//100,          //水印x轴间隔
            watermark_y_space:-15,//50,         //水印y轴间隔
            watermark_font:'微软雅黑',           //水印字体
            watermark_color:'black',            //水印字体颜色
            watermark_fontsize:'12px',//'18px', //水印字体大小
            watermark_alpha:0.15,               //水印透明度，要求设置在大于等于0.005
            watermark_width:310,//100,          //水印宽度
        ...
        for (var i = 0; i < defaultSettings.watermark_rows; i++) {
            ...
            for (var j = 0; j < defaultSettings.watermark_cols; j++) {
                ...
                // mask_div.style.border = '5px solid green';
                // mask_div.style.background = "#ff0000";
                // mask_div.style['white-space'] = "nowrap";
                mask_div.style['line-height'] = 4.0;
                mask_div.style.padding = '0px 20px 0px 30px';
                //设置水印相关属性end
                //附加到文档中
